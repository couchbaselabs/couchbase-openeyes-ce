    ...
    'components' => array(
        ...
        'request' => array(
            ...
            'noCsrfValidationRoutes' => array(
                ...
                'OphTrOperationbooking/theatreDiary/filterFirms',
                'OphTrOperationbooking/theatreDiary/filterWards',
                'OphTrOperationbooking/theatreDiary/setDiaryFilter',
                'OphTrOperationbooking/theatreDiary/checkRequired',
                'OphTrOperationbooking/theatreDiary/search',
                'OphTrOperationbooking/waitingList/filterFirms',
                'OphTrOperationbooking/waitingList/filterSetFirm',
                ...
                'worklist/changeStepStatus',
                'worklist/checkIn',
                'worklist/undoCheckIn',
                'worklist/didNotAttend',
                'worklist/deleteStep',
                'worklist/reorderStep',
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                // OphGeneric admin routes - bypass ExaminationAdmin for OphGeneric
                'OphGeneric/admin/<controller:\w+>/<action:\w+>/<id:\d+>' => 'OphGeneric/OphGenericAdmin/<controller>/<action>',
                'OphGeneric/admin/<controller:\w+>/<action:\w+>' => 'OphGeneric/OphGenericAdmin/<controller>/<action>',

                // Generic admin routes for other modules - convert to ExaminationAdmin (but not OphCiExamination, OphCoCvi, OphDrPrescription, OphDrPGDPSD, OphCoTherapyapplication, OphTrLaser, OphTrOperationbooking, OphCoCorrespondence, OphTrOperationnote, OphTrIntravitrealinjection, or OphGeneric)
                '<module:(?!OphCiExamination|OphCoCvi|OphDrPrescription|OphDrPGDPSD|OphCoTherapyapplication|OphTrLaser|OphTrOperationbooking|OphCoCorrespondence|OphTrOperationnote|OphTrIntravitrealinjection|OphGeneric|PASAPI)\w+>/admin/<controller:\w+>/<action:\w+>/<id:\d+>' => '<module>/ExaminationAdmin/<controller>/<action>',
                '<module:(?!OphCiExamination|OphCoCvi|OphDrPrescription|OphDrPGDPSD|OphCoTherapyapplication|OphTrLaser|OphTrOperationbooking|OphCoCorrespondence|OphTrOperationnote|OphTrIntravitrealinjection|OphGeneric|PASAPI)\w+>/admin/<controller:\w+>/<action:\w+>' => '<module>/ExaminationAdmin/<controller>/<action>',
                ...
                'benefit/<action:\w+>' => 'oeadmin/benefit/<action>',
                ...
                'commonMedications/<action:\w+>/<id:\d+>' => 'oeadmin/commonMedications/<action>',
                'commonMedications/<action:\w+>' => 'oeadmin/commonMedications/<action>',
                'anaestheticAgentDefaults/<action:\w+>/<id:\d+>' => 'oeadmin/anaestheticAgentDefaults/<action>',
                'anaestheticAgentDefaults/<action:\w+>' => 'oeadmin/anaestheticAgentDefaults/<action>',
                'eventLog/<action:\w+>/<id:\d+>' => 'oeadmin/eventLog/<action>',
                'eventLog/<action:\w+>' => 'oeadmin/eventLog/<action>',
                'postOpComplication/<action:\w+>/<id:\d+>' => 'oeadmin/postOpComplication/<action>',
                'postOpComplication/<action:\w+>' => 'oeadmin/postOpComplication/<action>',
                ...
                'opcsCode/<action:\w+>/<id:\d+>' => 'oeadmin/opcsCode/<action>',
                'opcsCode/<action:\w+>' => 'oeadmin/opcsCode/<action>',
