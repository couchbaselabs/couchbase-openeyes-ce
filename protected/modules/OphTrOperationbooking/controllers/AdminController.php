...
class AdminController extends ModuleAdminController
{
    ...
    public function actionSequenceInlineEdit()
    {
        ...
        foreach ($sequences as $sequence) {
            ...
            foreach (array('firm_id', 'theatre_id', 'start_time', 'end_time', 'interval_id', 'weekday', 'consultant', 'paediatric', 'anaesthetist', 'general_anaesthetic') as $field) {
                if (isset($_POST['inline_'.$field]) && $_POST['inline_'.$field] != '') {
            ...
            if (isset($_POST['inline_start_date']) && $_POST['inline_start_date'] != '') {
            ...
            if (isset($_POST['inline_end_date']) && $_POST['inline_end_date'] != '') {
            ...
            if (isset($_POST['inline_update_weeks']) && $_POST['inline_update_weeks']) {
                $weeks = 0;
                isset($_POST['inline_week1']) && $_POST['inline_week1'] && $weeks += 1;
                isset($_POST['inline_week2']) && $_POST['inline_week2'] && $weeks += 2;
                isset($_POST['inline_week3']) && $_POST['inline_week3'] && $weeks += 4;
                isset($_POST['inline_week4']) && $_POST['inline_week4'] && $weeks += 8;
                isset($_POST['inline_week5']) && $_POST['inline_week5'] && $weeks += 16;
    ...
    public function saveSessions($sessions)
    {
        ...
        foreach ($sessions as $session) {
            ...
            if (isset($_POST['inline_date']) && $_POST['inline_date'] != '') {
    ...
    {
        // Handle case where action is accessed directly as a page (GET request)
        if (empty($_POST['id'])) {
            $this->redirect(array('/OphTrOperationbooking/admin/viewPatientUnavailableReasons'));
            return;
        }
