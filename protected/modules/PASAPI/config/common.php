    ...
    'components' => [
        ...
        'urlManager' => [
            'rules' => [
                ...
                ['PASAPI/V1/update', 'pattern' => 'PASAPI/V1/<resource_type:\w+>/<id:\w+>/identifier-type/<identifier_type>', 'verb' => 'PUT'],
                ['PASAPI/V1/delete', 'pattern' => 'PASAPI/V1/<resource_type:\w+>/<id:\w+>', 'verb' => 'DELETE'],
            ],
        ],
