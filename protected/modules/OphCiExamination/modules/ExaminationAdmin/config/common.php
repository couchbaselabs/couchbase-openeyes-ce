...
$config = [
    ...
    'components' => [
        'urlManager' => [
            'rules' => [
                'OphCiExamination/ExaminationAdmin/freehandDraw/<action:\w+>/<id:\d+>' => 'OphCiExamination/ExaminationAdmin/FreehandDraw/<action>',
                'OphCiExamination/ExaminationAdmin/freehandDraw/<action:\w+>' => 'OphCiExamination/ExaminationAdmin/FreehandDraw/<action>',
                'OphCiExamination/ExaminationAdmin/<controller:\w+>/<action:\w+>/<id:\d+>' => 'OphCiExamination/ExaminationAdmin/<controller>/<action>',
