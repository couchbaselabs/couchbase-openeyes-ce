    ...
    public function actionAdd()
    {
        ...
        if (!empty($_POST)) {
            ...
            if (!$firm->validate()) {
                ...
                // Note: ServiceSubspecialtyAssignment linking is handled in Firm::beforeSave()
                // If no assignment exists, service_subspecialty_assignment_id will be NULL, which is allowed by the schema
