...
$fpten_dispense_condition_id = $fpten_dispense_condition ? $fpten_dispense_condition->id : null;
?>
  ...
  <table class="standard cols-full">
    ...
    <tr>
      ...
      <td>
        ...
        if ($fpten_dispense_condition_id) {
            $options['options'] = array(
                $fpten_dispense_condition_id => array('label' => "Print to $fpten_setting")
            );
        }
        echo CHtml::dropDownList('OphDrPrescription_ReportPrescribedDrugs[dispense_condition]', '', CHtml::listData($dispense_conditions, 'id', 'name'), $options);
        ?>
      </td>
      <td>Report Type</td>
      <td>
