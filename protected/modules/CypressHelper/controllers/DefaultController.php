...
class DefaultController extends \CController
{
    ...
    public function actionCreateUser()
    {
        ...
        // Get the actual username that was created (either from parameter or generated by factory)
        $created_username = $username;
        if (empty($created_username) && isset($user->authentications[0])) {
            $created_username = $user->authentications[0]->username;
        }

        $this->sendJsonResponse([
            'user_id' => $user->id,
            'username' => $created_username ?? 'Failed to retrieve username',
            'password' => $password
        ]);
    }
