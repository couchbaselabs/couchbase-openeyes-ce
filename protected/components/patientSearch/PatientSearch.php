...
class PatientSearch
{
    ...
    public function prepareSearch($term, $patient_identifier_type = null): array
    {
        ...
        $patient_criteria = array(
            ...
            'first_name' => isset($this->search_terms['first_name']) ? CHtml::decode($this->search_terms['first_name']) : '',
            'last_name' => isset($this->search_terms['last_name']) ? CHtml::decode($this->search_terms['last_name']) : '',
