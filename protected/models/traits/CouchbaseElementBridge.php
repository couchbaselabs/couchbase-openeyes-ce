<?php
/**
 * Core trait for event element models to support Couchbase embedding
 * Elements using this trait can be embedded within module documents (ExaminationDocument, etc.)
 * 
 * This is a core trait available to all modules, unlike the OphCiExamination-specific version.
 */
...
trait CouchbaseElementBridge
{
    ...
    public function shouldBeEmbedded()
    {
        ...
        return !in_array($className, $largeElements);
    }
    
    /**
     * Get the Couchbase scope for this element type
     * Override in specific element classes if needed
     * @return string
     */
    public function getCouchbaseScope()
    {
        return 'clinical';
    }
    
    /**
     * Get the Couchbase collection for this element type
     * Override in specific element classes if needed
     * @return string
     */
    public function getCouchbaseCollection()
    {
        return 'examination';
    }
}
