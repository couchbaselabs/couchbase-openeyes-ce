...
?>
  ...
  <div id="patientMergeWrapper" class="element-fields full-width col-gap element ">
    <form id="patientMergeSearchList">
      <div class="cols-8 ">
            <?php $this->renderPartial('//base/_messages') ?>
          <h2 class="event-title">Patient Merge Search</h2>
              ...
              <div class="cols-10 column">
                <label>
                  ...
                  <input type="checkbox" id="PatientMergeRequest_show_merged"
                         ...
                         value="1" <?php echo isset($filters) && $filters['show_merged'] && $filters['show_merged'] == 1 ? 'checked' : '' ?> >
                  Show merged
                </label>
              </div>
          ...
          <div class="grid-view" id="inbox-table">
                <?php $this->renderPartial(
                    ...
                    array('data_provider' => $data_provider, 'filters' => isset($filters) ? $filters : array())
                ) ?>
          </div>
      </div>
    </form>
