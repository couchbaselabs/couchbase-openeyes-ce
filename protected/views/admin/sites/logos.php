...
<div class="cols-full">
    ...
    <table class="standard cols-full">
            ...
            <tr>
                ...
                <td>
                    ...
                    if (empty($default_urls['primaryLogo']) && !($logo->primary_logo)) {
                        echo "<div class='alert-box info'>No uploaded primary logo and no system primary logo.</div>";
                    } else {
                        if ($logo && $logo->primary_logo) {
                            ...
                            echo '<br>' . CHtml::button(
                                ...
                                array(
                                    ...
                                    'confirm' => 'Are you sure you want to delete the primary logo? You will lose all unsaved edits.',
                                    'data-method' => "POST"
                                )
                            );
                            echo '</div>';
                    ...
                    ">';
                            ...
                            echo '<br>' . CHtml::button(
                                ...
                                array(
                                    ...
                                    'csrf' => true,
                                    'class' => 'remove-logo oe-i remove-circle small',
                                    'confirm' => 'Are you sure you want to delete the secondary logo? You will lose all unsaved edits.',
                                    'data-method' => "POST"
                                )
                            );
                            echo '</div>';
        ...
        <tfoot>
            <tr>
                <td colspan="2">
                    <?= $form->formActions(array('cancel' => 'Back', 'cancel-uri' => '/admin/sites')); ?>
                </td>
            </tr>
